...
export default function BookTicket() {
  ...
  const [receiptImage, setReceiptImage] = useState<string | ArrayBuffer | null>(null);
  ...
  const onSubmit = (data: { name: any; tripId: any; }) => {
    if (step === 1) {
      setStep(2);
    } else if (step === 2) {
          ...
          {step === 1 ? (
            <>
              ...
              <div className="mb-6">
                ...
                <Select {...register('tripId', { required: true })}>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select {...register('residencyStatus', { required: true })}>
                      <SelectTrigger>
              ...
              <div className="mb-6">
                ...
                <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod} className="flex flex-col space-y-3">
                  <div className="flex items-center space-x-2">
                    <RadioGroup value="gcash" id="gcash" />
                    <Label htmlFor="gcash">GCash (Upload Receipt)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroup value="cash" id="cash" />
