...
const PassengerFareType = ({ form, errors, isLabel }: MainPassengerInformationProps) => {
    const fareTypes = [
    ...
    return (
        <div className="mb-6">
            <Label htmlFor="passenger_fare_type" className={!!isLabel ? '' : 'text-lg font-medium'}>
...
export default PassengerFareType;
